...
func init() {
	...
	backfillCmd.PersistentFlags().String("btc-http-path", "", "http url for bitcoin node")
	...
	viper.BindPFlag("bitcoin.httpPath", backfillCmd.PersistentFlags().Lookup("btc-http-path"))
}
